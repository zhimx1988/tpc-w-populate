	...
	public static void deleteTables() {
		...
		for (i = 0; i < numTables; i++) {
			try {
				...
				PreparedStatement statement = con.prepareStatement("DROP TABLE " + tables[i].toLowerCase());
				statement.executeUpdate();
...
//			statement.clearBatch();
	...
	private static void populateOrdersAndCC_XACTSTable() {
		...
		System.out.println("Populating orders, order_line, cc_xacts with " + DBHelper.ordersNum
				+ " orders");
		try {
			 PreparedStatement statement = con
